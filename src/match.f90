...
! ilevel: print level
     ...
     &xold(*),w_ipvt(*)
      ...
      call mtgeti(vect,dvect)
      print * , "ddddddddd", nvar, dvect(2), dvect(1), vect(1), vect(2)
...
!---- Calculate the Jacobian matrix.
      print *, "gggggggepsil", epsil, fjac, ldfjac, iflag, ftol, wa4
      call fdjac2(fcn,m,n,x,fvec,fjac,ldfjac,iflag,ftol,wa4, dvect)
...
!----------------------------------------------------------------------*
     ...
     &x(n),dvect(n),zero,epsmch
      parameter(zero=0d0,epsmch=1d-16)
      external fcn
      double precision, external :: get_step_size_match 
      
      
      print *, "epppssshhhhh", epsfcn, epsmch, dvect(1), dvect(2)
      iflag = 0
      ...
      do j = 1, n
        ...
        !print *, "epppssshhhhh", epsfcn, epsmch, eps
        x(j) = temp
